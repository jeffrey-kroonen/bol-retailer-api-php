...
class BillingDetailsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JeffreyKroonen\\BolRetailer\\Generated\\Model\\BillingDetails';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return $data instanceof \JeffreyKroonen\BolRetailer\Generated\Model\BillingDetails;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \JeffreyKroonen\BolRetailer\Generated\Model\BillingDetails();
        ...
        if (\array_key_exists('kvkNumber', $data)) {
            $object->setKvkNumber($data['kvkNumber']);
        }
        if (\array_key_exists('orderReference', $data)) {
            $object->setOrderReference($data['orderReference']);
        }
        return $object;
    }
    /**
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getOrderReference()) {
            $data['orderReference'] = $object->getOrderReference();
        }
        return $data;
    }
}