...
class BillingDetailsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        $data = [];
        if ($object->isInitialized('salutation') && null !== $object->getSalutation()) {
        ...
        if ($object->isInitialized('kvkNumber') && null !== $object->getKvkNumber()) {
            $data['kvkNumber'] = $object->getKvkNumber();
        }
        if ($object->isInitialized('orderReference') && null !== $object->getOrderReference()) {
