    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('attributes', $data)) {
            ...
            foreach ($data['attributes'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'JeffreyKroonen\\BolRetailer\\Generated\\Model\\Attribute', 'json', $context);
            }
        ...
        if (\array_key_exists('assets', $data)) {
            ...
            foreach ($data['assets'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'JeffreyKroonen\\BolRetailer\\Generated\\Model\\Asset', 'json', $context);
            }
